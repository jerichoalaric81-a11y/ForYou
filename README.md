  ...
  <head>
    ...
    <style>
      body {
        ...
        background-video: url(https://in.pinterest.com/pin/background-png-for-video-and-photo-editing--727894358562100989/);
      }
    </style>
    <link
      rel="stylesheet"
  ...
  <body class="justify-center flex">
    ...
    >
      ...
      <div class="lh-1 text-center mt-4">
        ...
        <!-- ganti pertanyaan -->
        <p class="title question fs-1 text-2xl font-bold text-gray-700">do you love me??</p>
      </div>
      ...
      <div class="numbers hidden mt-5 flex justify-center">
        <!-- ganti link -->
        <a
          href="https://gifft.me/id/o/hm/tvu3hng3ks3e91hg8cctcejs"
          type="button"
          class="bg-green-500 text-white py-1 px-2 rounded btn-yes i do w-100 text-xl font-bold"
        >
    ...
    <script>
      ...
      function generateMessage(count) {
        const messages = ["nope", "kocak?", "dam, yakin?", "klik yes ga!", "huftt..", "<--"];
